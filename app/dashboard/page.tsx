...
export default async function DashboardPage() {
  ...
  const [totalProducts, lowStock, allProducts] = await Promise.all([
    ...
    prisma.product.findMany({
      where: { userId },
      select: { price: true, quantity: true, createdAt: true, lowStock: true },
    }),
  ]);
  ...
  const totalValue = allProducts.reduce(
    (sum:any, product) => sum + Number(product.price) * Number(product.quantity),
    0
  );
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="ml-64 p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div
                          className={`text-xs font-medium ${textColors[stockLevel]}`}
                        >
              ...
              <div className="flex items-center justify-center ">
                <div className="relative w-48 h-48">
                  <div
                    ...
                    style={{
                      clipPath:
                        "polygon(50% 50%, 0% 50%, 0% 0%, 100% 0%, 100% 100%, 0% 100%, 0% 50%)",
                    }}
                  ></div>
